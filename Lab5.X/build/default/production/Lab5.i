...
void EscribeLCD_n64(unsigned long long int a,unsigned char b);
...
void CaracterEspecial(unsigned char ,unsigned char *);
...
void EnviaDato(unsigned char a){
 if(interfaz==4){
  LATD=(LATD & 0b00001111) | (a & 0b11110000);
  HabilitaLCD();
  RetardoLCD(1);
  LATD=(LATD & 0b00001111) | (a<<4);
...
void EscribeLCD_n64(unsigned long long int a,unsigned char b){
    ...
    unsigned char decena,unidad;
 unsigned long long int centena,millarU,millarD,millarC,millonU,millonD,millonC;
    LATD0=1;
 switch(b){
  case 1: unidad=a%10;
                EscribeLCD_c(unidad+48);
  ...
  case 3: centena=(a%1000)/100;
    ...
    EscribeLCD_c(decena+48);
                EscribeLCD_c(unidad+48);
    break;
  case 4: millarU=(a%10000)/1000;
                centena=(a%1000)/100;
                decena=(a%100)/10;
    unidad=a%10;
                EscribeLCD_c(millarU+48);
    EscribeLCD_c(centena+48);
    EscribeLCD_c(decena+48);
                EscribeLCD_c(unidad+48);
    break;
  case 5: millarD =(a%100000)/10000;
    millarU=(a%10000)/1000;
                centena=(a%1000)/100;
                decena=(a%100)/10;
    unidad=a%10;
                EscribeLCD_c(millarD+48);
                EscribeLCD_c(millarU+48);
    EscribeLCD_c(centena+48);
    EscribeLCD_c(decena+48);
                EscribeLCD_c(unidad+48);
    break;
        case 6: millarC = (a%1000000)/100000;
                millarD =(a%100000)/10000;
    millarU=(a%10000)/1000;
                centena=(a%1000)/100;
                decena=(a%100)/10;
    unidad=a%10;
                EscribeLCD_c(millarC+48);
                EscribeLCD_c(millarD+48);
                EscribeLCD_c(millarU+48);
    EscribeLCD_c(centena+48);
    EscribeLCD_c(decena+48);
                EscribeLCD_c(unidad+48);
    break;
        case 7: millonU = (a%10000000)/1000000;
                millarC = (a%1000000)/100000;
                millarD =(a%100000)/10000;
    millarU=(a%10000)/1000;
                centena=(a%1000)/100;
                decena=(a%100)/10;
    unidad=a%10;
                EscribeLCD_c(millonU+48);
                EscribeLCD_c(millarC+48);
                EscribeLCD_c(millarD+48);
                EscribeLCD_c(millarU+48);
    EscribeLCD_c(centena+48);
    EscribeLCD_c(decena+48);
                EscribeLCD_c(unidad+48);
    break;
        case 8: millonD = (a%100000000)/10000000;
                millonU = (a%10000000)/1000000;
                millarC = (a%1000000)/100000;
                millarD =(a%100000)/10000;
    millarU=(a%10000)/1000;
                centena=(a%1000)/100;
    ...
    EscribeLCD_c(decena+48);
                EscribeLCD_c(unidad+48);
    break;
        case 9: millonC = (a%1000000000)/100000000;
                millonD = (a%100000000)/10000000;
                millonU = (a%10000000)/1000000;
                millarC = (a%1000000)/100000;
                millarD =(a%100000)/10000;
    millarU=(a%10000)/1000;
...
void CaracterEspecial(unsigned char pos, unsigned char *msg){
    unsigned char i;
    if(pos<8){
        DireccionaLCD(0x40+(pos*8));
        for(i=0;i<8;i++){
            EscribeLCD_c(msg[i]);
        }
    }
...
void RetardoLCD(unsigned char a){
 switch(a){
  case 1: _delay((unsigned long)((15)*(8000000/4000.0)));

    break;
  case 2: _delay((unsigned long)((1)*(8000000/4000.0)));
                _delay((unsigned long)((640)*(8000000/4000000.0)));

    break;
  case 3: _delay((unsigned long)((100)*(8000000/4000000.0)));

    break;
  case 4: _delay((unsigned long)((40)*(8000000/4000000.0)));
...
unsigned char Temp,Hum,Che,lectura;
unsigned long long int auxT;
...
void mandarBT(void){
    ...
    if(tipo==0){
        ...
        auxT=(((int)(Temp))*1.8)+32;
        Transmitir(auxT/100 + 48);
        Transmitir((auxT%100)/10 + 48);
        Transmitir(auxT%10 + 48);
        Transmitir(' ');
        Transmitir('F');
    }
    else if(tipo==2){
        auxT=(((int)(Temp)))+273.15;
        Transmitir(auxT/100 + 48);
        Transmitir((auxT%100)/10 + 48);
        Transmitir(auxT%10 + 48);
        Transmitir(' ');
...
void mandarLCD(void){
    ...
    if(tipo==0){
        EscribeLCD_c(" ");
        EscribeLCD_n8(Temp, 2);
        MensajeLCD_Var(" C");
    }
    else if(tipo==1){
        auxT=((Temp)*1.8)+32;
        EscribeLCD_n16(auxT, 3);
        MensajeLCD_Var(" F");
    }
    else if(tipo==2){
        auxT=(Temp)+273.15;
...
unsigned char LeerBit(void){
  unsigned char res=0;
  while(RC2==0);
  _delay((unsigned long)((13)*(8000000/4000000.0)));
  if(RC2==1) res=0;
  _delay((unsigned long)((22)*(8000000/4000000.0)));
  if(RC2==1){
    res=1;
    while(RC2==1);
  }
