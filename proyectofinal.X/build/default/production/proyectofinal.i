...
int vactual=0,vs=5,carro=0,contador=0;
const int piso1=1000;
const int piso2=1500;
const int piso3=2000;
...
void setorigin(void){
  ...
  while(RB2==1){
        if(RB2 == 1)LATB5=1;
        _delay((unsigned long)((stepDelay)*(8000000/4000.0)));
        LATB5=0;
        _delay((unsigned long)((stepDelay)*(8000000/4000.0)));
  }
  while(RB0 == 1 || RB1 == 1){
...
void ira(int desX,int desY){
 if(desX < posX)LATE0= 1;
  else LATE0 = 0;
   if(desY < posY)LATE1 = 1;
  else LATE1 = 0;
